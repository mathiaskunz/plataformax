...
public class TelaMensagem extends javax.swing.JFrame {
    ...
    public TelaMensagem(Configuration config, String contact, boolean firstMessage) {
        ...
        this.user = config.getConnection().getUser()
                .substring(0, config.getConnection().getUser().indexOf("@"));
        initComponents();
    ...
    private void sendMessage(Message message) {
        ...
        Chat newChat = createChat(chatmanager);
    ...
    private void botaoEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEnviarActionPerformed
        ...
        sendMessage(campoDigitarMensagem.getText(), createChat(chatmanager));
